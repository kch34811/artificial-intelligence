...
grader.add_basic_part('1c-0-basic', test1c0, max_points=2, description='simple test')
...
grader.add_basic_part('2f-0-basic', lambda: grader.require_is_equal(5, submission.euclidean_distance((1, 5), (4, 1))),
                      max_points=2, description='simple test case')
...
grader.add_hidden_part('3a-1-hidden', test3a1, max_points=1, description='random trials')
...
grader.add_hidden_part('3a-2-hidden', test3a2, max_points=1, description='random trials (bigger)')
